...
public class SessionManager {
    ...
    public String getPinNumber() {
        return pref.getString(PIN_NUMBER, "PinNumber");
    }

    public void setIsAppFirstRun(boolean isAppFirstRun) {
        editor.putBoolean(IS_APP_FIRST_RUN, isAppFirstRun);
        editor.commit();
    }
    public boolean isAppFirstRun(){
        return pref.getBoolean(IS_APP_FIRST_RUN,false);
    }
