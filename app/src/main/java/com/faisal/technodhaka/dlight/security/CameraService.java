...
/**
 * Created by TD-Android on 10/17/2017.
 */
public class CameraService extends Service implements SurfaceHolder.Callback {
    ...
    /**
     * If any instance of camera are open then it will be
     * close
     */
    ...
    private Camera openFrontFacingCameraGingerbread() {
        ...
        /**
         * get the number of the camera from {@link cameraInfo object }
         */
    ...
    Camera.PictureCallback mCall = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            if (!imagesFolder.exists())
                imagesFolder.mkdirs(); // <----
            File image = new File(imagesFolder, Configuration.PHOTO_NAME
                    + ".jpg");
